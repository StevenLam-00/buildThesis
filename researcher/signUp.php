...
<head>
    ...
    <!-- Title -->
    <title>Sign Up | Add Researcher</title>
            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <form id="example-form" method="post" name="signUp">
                            <div>
                                <section>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        ...
                                                        <input id="username" name="username"
                                                            onBlur="checkAvailabilityUName()" type="text"
                                                            autocomplete="off" required>
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12" style="margin-top: 30px;">
                                                        <button type="submit" name="signUp" onclick="return valid();"
                                                            id="signUp"
                                                            class="waves-effect waves-light btn indigo m-b-xs">SIGN
                                                            UP</button>
                                                        <a class="waves-effect waves-grey" href="index.php"
                                                            style="margin-bottom: 10px; margin-left: 10px;">Already have
                                                            an
                                                            account?</a>
                                                    </div>
