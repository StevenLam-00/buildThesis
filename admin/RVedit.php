...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update reviewer set fullname=:fName,field=:field, phonenumber=:pNumber, academicrank=:aRank, password=:newPassword where id=:id";
...
<body>
    ...
    <main class="mn-inner">
        <div class="row">
            <div class="col s12">
                <div class="page-title">Update reviewer</div>
            </div>
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <form id="example-form" method="post" name="updateRV">
                            <div>
                                <h4 style="color: green;">Update Reviewer Details</h4>
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="rvcode">Reviewer ID</label>
                                                        <input name="rvcode" id="rvcode"
                                                            value="<?php echo "RV - " . htmlentities($result->id); ?>"
